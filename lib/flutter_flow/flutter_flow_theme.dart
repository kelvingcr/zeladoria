...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFFE0FBFC);
  ...
  late Color yInMnBlue = Color(0xFF3D5A80);
  late Color powderBlue = Color(0xFF98C1D9);
  late Color lightCyan = Color(0xFFE0FBFC);
  late Color burntSienna = Color(0xFFEE6C4D);
  late Color gunmetal = Color(0xFF293241);
}
